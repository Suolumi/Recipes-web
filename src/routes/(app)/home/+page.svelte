<script>
    ...
    import {RecipeTypes} from "$lib/recipes";
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-foreground mb-4 text-balance">Discover Amazing Recipes</h1>
        <p class="text-xl text-muted-foreground text-pretty">Find your next favorite dish from our community of home cooks</p>
    </div>
