<script lang="ts">
    ...
    let showMenuDropdown: boolean = $state(false);
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2 md:gap-4">
                    ...
                    <div class="md:hidden">
                        <Drawer.Trigger>
                            <button class="text-foreground hover:text-primary" aria-label="Menu" onclick={() => showProfileDropdown = !showMenuDropdown}>
                        ...
                        <Drawer.Portal>
                            ...
                            <Drawer.Content
                                    class="fixed bottom-0 right-0 mt-24 flex h-[95%] w-[60%] rounded-t-[10px] bg-white"
                            >
